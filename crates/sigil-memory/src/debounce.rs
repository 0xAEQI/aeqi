...
mod tests {
    ...
    fn push_dedup_same_key_replaces() {
        ...
        queue.push(make_write("sigil", "auth/jwt", "rotation every 24h", now));
    ...
    fn drain_ready_respects_debounce_window() {
        ...
        queue.push(make_write("sigil", "old-write", "old content", old));
        queue.push(make_write("sigil", "recent-write", "new content", recent));
    ...
    fn drain_ready_returns_nothing_when_all_too_new() {
        ...
        queue.push(make_write("sigil", "fresh", "just added", recent));
    ...
    fn drain_ready_removes_from_queue() {
        ...
        queue.push(make_write("sigil", "key-1", "content 1", old));
        queue.push(make_write("sigil", "key-2", "content 2", old));
    ...
    fn pending_count_and_is_empty() {
        ...
        queue.push(make_write("sigil", "key", "content", Utc::now()));
        assert_eq!(queue.pending_count(), 1);
        assert!(!queue.is_empty());
    }
    ...
    fn clear_empties_queue() {
        ...
        queue.push(make_write("sigil", "k1", "c1", now));
        queue.push(make_write("sigil", "k2", "c2", now));
