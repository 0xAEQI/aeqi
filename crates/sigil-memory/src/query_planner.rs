...
mod tests {
    ...
    fn plan_channel_propagated() {
        let plan = QueryPlanner::plan("hello", Some("sigil/engineering"));
        assert_eq!(plan.channel.as_deref(), Some("sigil/engineering"));
        ...
        let general = plan
            ...
            .unwrap();
        assert!(
            general.query_text.contains("sigil/engineering"),
