...
impl ContextBudget {
    /// Create from sigil.toml config.
    pub fn from_config(cfg: &sigil_core::ContextBudgetConfig) -> Self {
        Self {
    ...
    pub fn budget_checkpoints(&self, checkpoints: &[sigil_tasks::Checkpoint]) -> String {
    ...
    pub fn apply_to_identity(&self, identity: &sigil_core::Identity) -> String {
...
mod tests {
    ...
    fn test_budget_checkpoints_few() {
        ...
        let cps = vec![sigil_tasks::Checkpoint {
