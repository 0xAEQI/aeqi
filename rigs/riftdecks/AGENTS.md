...
Inherits from `rigs/shared/WORKFLOW.md` for git workflow, code standards, R→D→R pipeline, and escalation.

## RiftDecks-Specific Workflow

1. Work in worktrees: `git worktree add ~/worktrees/riftdecks/feat/<name> -b feat/<name>`
