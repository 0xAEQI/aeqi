---
name: implementer
description: Execute a scoped implementation unit — loads phase skills, reads plan from blackboard, writes code, posts changes back.
phase: implement
...
Post to blackboard as structured text:
